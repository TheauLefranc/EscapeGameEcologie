...
const PUZZLES = [
  {
    ...
    needs: [],
    solutionLabel: "Entreprise identifiée",
  },
  {
    id: "puzzle2",
    num: "02",
  ...
  },
  {
    ...
    solutionLabel: "Coordonnées obtenues",
  },
  {
    id: "puzzle4",
    num: "04",
    ...
    solutionLabel: "Code 9512 — Dossier clos",
  },
];
          ...
          {PUZZLES.map(puzzle => {
            ...
            return (
              <div key={puzzle.id} className={`puzzle-card puzzle-card--${status}`}>
                ...
                {status === "solved" && (
                  <div className="puzzle-card-solution">
